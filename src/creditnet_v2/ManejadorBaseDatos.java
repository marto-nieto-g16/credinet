package creditnet_v2; // coloca la clase compilada en tpvlibre/conexiones
...
public class ManejadorBaseDatos {
    ...
    private String usuario = "sql10222900"; // usuario con permisos para conectarse a BD
    private String password = "J233F1dJmB"; // contrase�a del usuario que se puede conectar
    ...
    private String basedatos = "jdbc:mysql://sql10.freesqldatabase.com/sql10222900";
